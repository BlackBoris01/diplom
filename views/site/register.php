...
<div class="auth-page">
    ...
    <div class="auth-right">
        <div class="auth-form-container">
            <div class="floating-label">Регистрация</div>
            ...
            <?= $form->field($model, 'nickname')->textInput(['placeholder' => 'Псевдоним']) ?>
            <?= $form->field($model, 'password')->passwordInput(['placeholder' => 'Пароль']) ?>

            <div class="form-group">
                <?= Html::submitButton('зарегистрироваться', ['class' => 'btn btn-primary auth-submit']) ?>
            </div>

            <div class="auth-links">
                <span>Уже зарегистрированы?</span>
                <?= Html::a('Вход', ['/site/login'], ['class' => 'auth-link']) ?>
            </div>
